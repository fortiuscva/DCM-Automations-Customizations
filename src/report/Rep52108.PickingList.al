report 52108 "THK Picking List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/THKPickingList.rdl';
    Caption = 'THK Picking List';
    ...
    dataset
    {
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(NewPageByWhseDocLineNoVarGbl; NewPageByWhseDocLineNoVarGbl)
                {
                }
                dataitem("Warehouse Activity Line"; "Warehouse Activity Line")
                {
                    ...
                    RequestFilterFields = "Whse. Document Line No.";
                ...
                dataitem(WhseActLine; "Warehouse Activity Line")
                {
                    ...
                    column(WhseDocumentLineNo_WhseActLine; "Whse. Document Line No.")
                    {
                    }
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(NewPageByWhseDocLineNoVarGbl; NewPageByWhseDocLineNoVarGbl)
                    {
                        ApplicationArea = All;
                        Caption = 'New Page by Whse. Doc. Line No.';
                    }
                }
            }
        }
        ...
        begin
            ...
            NewPageByWhseDocLineNoVarGbl:=false;
        end;
        trigger OnOpenPage()
        begin
    ...
    NewPageByWhseDocLineNoVarGbl: Boolean;
    WhseActLineNoVarGbl: Boolean;
