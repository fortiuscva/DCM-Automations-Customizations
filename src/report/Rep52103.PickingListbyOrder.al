report 52103 "THK Picking List by Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/THKPickingListbyOrder.rdl';
                ...
                dataitem(CopyNo; "Integer")
                {
                    ...
                    dataitem(PageLoop; "Integer")
                    {
                        ...
                        dataitem("Sales Line"; "Sales Line")
                        {
                            ...
                            column(Sales_Line_Item_Reference_No_; "Item Reference No.")
                            {
                            }
                            ...
                            begin
                                Item.Get("No.");
                                if Item."Item Tracking Code" <> '' then with TrackSpec2 do begin
    ...
    procedure AnySalesLinesThisLocation(LocationCode: Code[10]): Boolean var
