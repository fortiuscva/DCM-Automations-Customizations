report 52106 "THK Sales Shipment NA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/THKSalesShipmentNA.rdl';
    Caption = 'THK Sales Shipment';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BillToCustomerNoCaptionLbl; BillToCustomerNoCaptionLbl)
                    {
                    }
                    ...
                    column(DocumentDate_SalesShptHeader; Format("Sales Shipment Header"."Document Date", 0, 4))
                    {
                    }
                    ...
                    column(ExternalDocumentNo__SalesShptHeader; "Sales Shipment Header"."External Document No.")
                    {
                    }
                    column(OrderedByCaption; OrderedByCaptionLbl)
                    {
                    }
                    column(BilledToCaption; BilledToCaptionLbl)
                    {
                    }
                    dataitem(SalesShptLine; "Integer")
                    {
                        ...
                        column(LineShipmentDateCaptionLbl; LineShipmentDateCaptionLbl)
                        {
                        }
                        column(TempSalesShptShipmentDate; Format(TempSalesShipmentLine."Shipment Date"))
                        {
                        }
                        column(TempSalesShipmentLine_ItemReference; TempSalesShipmentLine."Item Reference No.")
                        {
                        }
                        column(PrintItemReferenceVarGbl; PrintItemReferenceVarGbl)
                        {
                        }
                        dataitem(AsmLoop; "Integer")
                        {
                            ...
                            begin
                                ...
                                if not TempSalesShipmentLineAsm.Get(TempSalesShipmentLine."Document No.", TempSalesShipmentLine."Line No.")then CurrReport.Break();
 ...
 Clear(CopyTxt)
    ...
    begin
        ...
        CompanyAddress[8]:=CompanyInfo."Phone No.";
        CompressArray(CompanyAddress);
    end;
    ...
    procedure SetPrintItemReferenceNo(PrintItemReferenceNoPar: Boolean)
    begin
        PrintItemReferenceVarGbl:=PrintItemReferenceNoPar;
    end;
}
